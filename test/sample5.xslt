                        ...
                        <fo:table margin-bottom="3mm">
                            ...
                            <fo:table-body>
                                <fo:table-row height="16px"
                                    ...
                                    <fo:table-cell>
                                        <fo:block text-align="center">保養工單</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                            ...
                            <fo:table-body>
                                <fo:table-row height="16px"
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">名稱</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">工作群組</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                ...
                                <fo:table-row height="16px"
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">說明</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">品保群組</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                ...
                                <fo:table-row height="16px"
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">開始時間</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">週期</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                ...
                                <fo:table-row height="16px"
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="right"
                                                  margin-right="0.1cm">完成時間</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                        ...
                        <fo:table table-layout="auto"
                            ...
                            <fo:table-header>
                                <fo:table-row height="16px"
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="center">序號</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
                                                  text-align="center">項目名稱</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold"
